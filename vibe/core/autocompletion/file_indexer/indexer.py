...
DEBOUNCE_DELAY = 0.3  # 300ms debounce delay for file changes
MAX_DEBOUNCE_DELAY = 2.0  # Maximum debounce delay for rapid changes
...
class FileIndexer:
    ...
    def _handle_watch_changes(
        ...
        """Handle file watch changes with debouncing to reduce filesystem overhead."""
    ...
    def _process_debounced_changes(self, root: Path) -> None:
