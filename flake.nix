  ...
  outputs = {
    ...
    in {
      ...
      packages.default = mkApplication {
        venv = pythonSet.mkVirtualEnv "porker-vibe-env" workspace.deps.default;
        package = pythonSet.porker-vibe;
      };
        ...
        default = let
          ...
          editablePythonSet = pythonSet.overrideScope (
            lib.composeManyExtensions [
              ...
              (final: prev: {
                porker-vibe = prev.porker-vibe.overrideAttrs (old: {
          ...
          virtualenv = editablePythonSet.mkVirtualEnv "porker-vibe-dev-env" workspace.deps.all;
        in
          pkgs.mkShell {
            packages = [
              virtualenv
